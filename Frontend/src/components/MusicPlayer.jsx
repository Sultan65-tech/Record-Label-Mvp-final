...
// Tracks
var tracks = ["src/lonely.mp3","src/new.mp3","src/never.mp3","src/you.mp3"]
      // State variables
...
// console.log(count);
// count --;
  setSong(tracks[count])
}

 return (

<div className="music-flex">
    <div className="music-image"><img src="src/Images/baby.jpg" alt="" /></div>
...
</div><div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false" onClick={Next} className="icon1 next_btn" style={{cursor:"pointer"}}><path d="M9 6.1017C9 5.0278 10.2649 4.4538 11.0732 5.161L17.3838 10.6828C18.1807 11.3801 18.1807 12.6196 17.3838 13.3169L11.0732 18.8387C10.2649 19.5459 9 18.9719 9 17.898L9 6.1017Z" className="caretRight"></path></svg>
</div>
  </div>
